...
class ScheduleUI:
    ...
    def pop_up_box(self, main_form, song_length):
        ...
        self.canvas_width = 543
        self.canvas_height = 543
        ...
        label = tk.Label(master = frame, font = ('Arial', 12),
        ...
        label = tk.Label(master = clear_frame, font = ('Arial', 12), text = 'Clear the curves of')
        ...
        tk.Label(master = clear_frame, font = ('Arial', 12), text = '/').grid(row = 0, column = 2)
        clear_all_moods = tk.Button(master = clear_frame, text = 'All', command = self.clear_all_clicked)
        clear_all_moods.grid(row = 0, column = 3)
        tk.Label(master = clear_frame, font = ('Arial', 12), text = 'moods from').grid(row = 0, column = 4)
        ...
        tk.Label(master = clear_frame, font = ('Arial', 12), text = '% to').grid(row = 0, column = 6)
        ...
        tk.Label(master = clear_frame, font = ('Arial', 12), text = '% of the song').grid(row = 0, column = 8)
...
class MainUI:
    ...
    def gui(self):
        ...
        for i in range(len(Mood.mood_strs)):
            ...
            self.mood_labels.append(tk.Label(master = frame, font = ('Arial', 12), height = 1, width = 13,
        ...
        # progress scale
        self.progress_scale = tk.Scale(master = frame, length = 460, resolution = 1, showvalue = True,
                                  orient = tk.HORIZONTAL, repeatinterval = 1, state = tk.DISABLED)
        self.progress_scale.grid(row = 8, column = 0, columnspan = 5)
        self.progress_scale.bind('<ButtonPress>', self.progress_scale_pressed)
        self.progress_scale.bind('<ButtonRelease>', self.progress_scale_released)
        tk.Label(master = frame, font = ('Arial', 8)).grid(row = 9, column = 0, columnspan = 5)    
        ...
        self.tempo_label = tk.Label(master = speed_frame, font = ('Arial', 12), text = 'Speed ')

    ...
    def init():
        Instrument.descriptions = [
            ...
            {'Name': 'Church Organ', 'Type': 'Organ', 'ID': 19, 
             'Is': [Mood.Sad], 
             'Is Not': [Mood.Angry, Mood.Comic, Mood.Happy, Mood.Mysterious, Mood.Romantic, Mood.Calm]}, 
            {'Name': 'Reed Organ', 'Type': 'Organ', 'ID': 20, 
             'Is': [Mood.Scary], 
             'Is Not': [Mood.Angry, Mood.Happy, Mood.Mysterious, Mood.Romantic, Mood.Calm]}, 
            ...
            {'Name': 'Tango Accordion', 'Type': 'Organ', 'ID': 23, 
             'Is': [Mood.Scary], 
             'Is Not': [Mood.Angry, Mood.Happy, Mood.Calm]}, 
